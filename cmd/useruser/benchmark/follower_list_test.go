...
func BenchmarkUserRelationFollowerList(b *testing.B) {
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		//设置传入参数
		...
		_, _ = uuservice.UserRelationFollowerList(context.Background(), &req)
	}
}
func BenchmarkUserRelationFollowerListParallel(b *testing.B) {
	b.ResetTimer()
